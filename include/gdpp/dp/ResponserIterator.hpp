...
public:
    ...
    ResponserIterator(struct gd_dp_rsp_it it) : m_it(it) {}
    ResponserIterator(ResponserIterator const & o) : m_it(o.m_it) {}

    ResponserIterator & operator=(struct gd_dp_rsp_it const & o) { m_it = o; return *this; }
...
public:
    ...
    ConstResponserIterator(struct gd_dp_rsp_it it) : m_it(it) {}
    ...
    ConstResponserIterator & operator=(struct gd_dp_rsp_it const & o) { m_it = o; return *this; }
