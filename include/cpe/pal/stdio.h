...
/* PS Method Start */
	...
	*/
	...
	#else
		#define snprintf(dest,count,fmt,...)				_snprintf_s(dest,count,count,fmt,__VA_ARGS__)
		#define vsnprintf(dest,count,fmt,valist)			_vsnprintf_s(dest,count,count,fmt,valist)
		#define snwprintf				_snwprintf
		#define vsnwprintf				_vsnwprintf
	#endif	
