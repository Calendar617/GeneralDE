...
#include <stdlib.h>
		...
		#define CPE_OS_LITTLEENDIAN

		#if defined (CPE_OS_BIGENDIAN)
			#undef CPE_OS_BIGENDIAN
		#endif
	#else
		#define CPE_OS_BIGENDIAN
		#if defined (CPE_OS_LITTLEENDIAN)
			#undef CPE_OS_LITTLEENDIAN
		#endif
	#endif
...
#define CPE_OS_DIRDOT					'.'
#define	CPE_OS_DIRBAR					'_'

#ifdef WIN32
	#define	CPE_OS_DIRSEP				'\\'
#else /* WIN32 */
	#define	CPE_OS_DIRSEP				'/'
#endif /* WIN32 */
...
/* PS Method Start. */
	...
	#define CPE_OS_TMP_DIR				"C:\\Temp\\"
	#define CPE_OS_LOG_DIR				"C:\\Log\\"
	...
	#define CPE_OS_MAX_CHILD	MAXIMUM_WAIT_OBJECTS
	...
	#define CPE_OS_TMP_DIR				"/tmp/"
	#define CPE_OS_LOG_DIR				"/var/log/"
...
#define CPE_OS_LINUX			0x01
#define CPE_OS_WIN9X			0x100
#define CPE_OS_WINNT			0x200

/** *******************************************************************
*	@brief  this function is used to get the type of the operation system.
*	@return	the type of the operation system.
*	@retval CPE_OS_LINUX, It's linux OS.
*	@retval CPE_OS_WIN9X, It's WIN9X OS.
*	@retval CPE_OS_WINNT, It's WINNT OS.
*********************************************************************/
